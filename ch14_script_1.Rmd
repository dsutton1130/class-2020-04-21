...
logistic_fit <- fit(logistic_mod, trump ~ gender + age + educ + race + income + party + ideology, data = cces)
...
dom <- tibble(gender = "Male", age = 37, educ = 5, race = "Asian", income = 8, ideology = 3, party = 3)
...
trump_vote_forest <- fit(forest_mod, trump ~ gender + age + educ + race + income + party + ideology, data = cces)
